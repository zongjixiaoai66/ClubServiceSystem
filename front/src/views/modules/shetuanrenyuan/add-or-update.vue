<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="负责区域" prop="fuzequyu">
          <el-input v-model="ruleForm.fuzequyu" 
              placeholder="负责区域" clearable  :readonly="ro.fuzequyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="负责区域" prop="fuzequyu">
              <el-input v-model="ruleForm.fuzequyu" 
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shetuanrenyuan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shetuanrenyuanCrossAddOrUpdateFlag = false;
						 this.parent.search();
