<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="咨询状态" prop="zixunzhuangtai">
          <el-select :disabled="ro.zixunzhuangtai" v-model="ruleForm.zixunzhuangtai" placeholder="请选择咨询状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="咨询状态" prop="zixunzhuangtai">
	      <el-input v-model="ruleForm.zixunzhuangtai"
                placeholder="咨询状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="装机预算" prop="zhuangjiyusuan">
          <el-input v-model="ruleForm.zhuangjiyusuan" 
              placeholder="装机预算" clearable  :readonly="ro.zhuangjiyusuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="装机预算" prop="zhuangjiyusuan">
              <el-input v-model="ruleForm.zhuangjiyusuan" 
                placeholder="装机预算" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="专业特征" prop="zhuanyetezheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="专业特征"
                  v-model="ruleForm.zhuanyetezheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuanyetezheng" label="专业特征" prop="zhuanyetezheng">
                    <span>{{ruleForm.zhuanyetezheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="装机需求" prop="zhuangjixuqiu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="装机需求"
                  v-model="ruleForm.zhuangjixuqiu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhuangjixuqiu" label="装机需求" prop="zhuangjixuqiu">
                    <span>{{ruleForm.zhuangjixuqiu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	zhuanye : false,
	zixunshijian : false,
	zixunzhuangtai : false,
	zhuanyetezheng : false,
	zhuangjixuqiu : false,
	zhuangjiyusuan : false,
      },
      ruleForm: {
        xuehao: '',
        xingming: '',
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zixunshijian = true;
          ...
          if(o=='zixunzhuangtai'){
            this.ruleForm.zixunzhuangtai = obj[o];
	    this.ro.zixunzhuangtai = true;
            continue;
          }
          if(o=='zhuanyetezheng'){
            this.ruleForm.zhuanyetezheng = obj[o];
	    this.ro.zhuanyetezheng = true;
            continue;
          }
          if(o=='zhuangjixuqiu'){
            this.ruleForm.zhuangjixuqiu = obj[o];
	    this.ro.zhuangjixuqiu = true;
            continue;
          }
          if(o=='zhuangjiyusuan'){
            this.ruleForm.zhuangjiyusuan = obj[o];
	    this.ro.zhuangjiyusuan = true;
            continue;
          }
        }
       this.ruleForm.zixunzhuangtai='未回复'
      }
      // 获取用户信息
      this.$http({
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhuangjizixun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhuangjizixunCrossAddOrUpdateFlag = false;
						 this.parent.search();
