<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="咨询时间" prop="zixunshijian">
          <el-input v-model="ruleForm.zixunshijian" 
              placeholder="咨询时间" clearable  :readonly="ro.zixunshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="咨询时间" prop="zixunshijian">
              <el-input v-model="ruleForm.zixunshijian" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="配置方案" prop="peizhifangan">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.peizhifangan" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peizhifangan" label="配置方案" prop="peizhifangan">
                    <span v-html="ruleForm.peizhifangan"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huifushijian = true;
          ...
          if(o=='peizhifangan'){
            this.ruleForm.peizhifangan = obj[o];
	    this.ro.peizhifangan = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.peizhifangan = this.ruleForm.peizhifangan.replace(reg,'../../../springboot48zml/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
