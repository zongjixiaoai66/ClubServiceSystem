      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.banjihao" class="input" type="text" placeholder="班级号">
			   </div>
			 </div> -->
			<el-form-item label="班级号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.banjihao" autocomplete="off" placeholder="班级号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<!-- <div v-if="tableName=='shetuanrenyuan'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			     <input v-model="ruleForm.mima" class="input" type="text" placeholder="密码">
			   </div>
			 </div> -->
			<el-form-item label="密码" class="input" v-if="tableName=='shetuanrenyuan'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='shetuanrenyuan'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='shetuanrenyuan'">
			  <el-input v-model="ruleForm.xingming" autocomplete="off" placeholder="姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shetuanrenyuan'" class="input-group">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='shetuanrenyuan'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shetuanrenyuan'" class="input-group">
			   <div class="label">负责区域</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fuzequyu" class="input" type="text" placeholder="负责区域">
			   </div>
			 </div> -->
			<el-form-item label="负责区域" class="input" v-if="tableName=='shetuanrenyuan'">
			  <el-input v-model="ruleForm.fuzequyu" autocomplete="off" placeholder="负责区域"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.gongzuobianhao) && `shetuanrenyuan` == this.tableName){
        this.$message.error(`工作编号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `shetuanrenyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `shetuanrenyuan` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.xingming) && `shetuanrenyuan` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
      if(`shetuanrenyuan` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
